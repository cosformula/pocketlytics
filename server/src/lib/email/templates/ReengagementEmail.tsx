...
const DOCS_URL = "https://www.pocketlytics.local/docs";
...
export const ReengagementEmail = ({
  ...
  const dashboardUrl = `https://app.pocketlytics.local/${siteId}`;
      ...
      >
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-8 px-6 max-w-[600px]">
            <Img
              src="https://app.pocketlytics.local/pocketlytics-text.svg"
              alt="Pocketlytics"
              width="120"
              height="28"
              className="mb-8"

...
IMPORTANT: Include a section about analytics that mentions they use Pocketlytics (https://pocketlytics.local), a privacy-focused, cookieless analytics platform that doesn't track users across sites and is GDPR compliant.

Return the privacy policy in markdown format with proper headings, sections, and formatting. Include sections for:
- Information We Collect
- How We Use Your Information
- Cookies and Tracking (mention that Pocketlytics doesn't use cookies)
- Data Sharing
- Your Rights
- Contact Information

export const metadata = {
  ...
  description: "Pocketlytics Data Processing Agreement (DPA) - how we process data on your behalf",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          This Data Processing Agreement (&quot;DPA&quot;) forms part of the agreement between Pocketlytics
          (&quot;Processor&quot;, &quot;we&quot;, &quot;us&quot;) and the customer (&quot;Controller&quot;,
          &quot;you&quot;) for the provision of Pocketlytics&apos;s web analytics services (&quot;Services&quot;).
        </p>
        <p>
          This DPA applies to the processing of personal data by Pocketlytics on behalf of the Controller in connection with
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>&quot;Sub-processor&quot;</strong> means any third party engaged by Pocketlytics to process Personal Data
        ...
        <p>
          Pocketlytics processes Personal Data solely for the purpose of providing the web analytics Services as described in
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Ensure instructions to Pocketlytics comply with applicable data protection laws</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Sub-processors</h2>
        <p>
          The Controller authorizes Pocketlytics to engage Sub-processors for the provision of the Services. Pocketlytics will
        ...
        <p>Pocketlytics implements appropriate technical and organizational measures to protect Personal Data, including:</p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p>
          If Personal Data is transferred outside the European Economic Area (EEA), Pocketlytics ensures appropriate
        ...
        <p>
          Pocketlytics will assist the Controller in fulfilling its obligations to respond to Data Subject requests, including
        ...
        <p>
          Pocketlytics retains Personal Data for the duration specified in our Privacy Policy or as agreed with the
        ...
        <p>
          Pocketlytics will make available to the Controller information necessary to demonstrate compliance with this DPA and
        ...
        <p>
          ...
          <a href="mailto:hello@pocketlytics.local" className="text-emerald-400 hover:text-emerald-300 ml-1">
            hello@pocketlytics.local
          </a>
        </p>
      </div>
    </div>

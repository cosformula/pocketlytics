export const metadata = {
  ...
  description: "Pocketlytics terms and conditions of service",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          By accessing and using Pocketlytics, you accept and agree to be bound by the terms and provision of this agreement.
          If you do not agree to these terms, please do not use our service.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Description of Service</h2>
        <p>
          Pocketlytics is an open-source, privacy-friendly web analytics platform. We provide both a cloud-hosted service and
        ...
        <p>You agree to use Pocketlytics only for lawful purposes and in accordance with these Terms. You agree not to:</p>
        ...
        <p>
          Pocketlytics is open-source software released under the AGPL 3.0 License. The self-hosted version is free to use, modify,
        ...
        <p>
          Pocketlytics does not collect personally identifiable information from your website visitors. Our service is
        ...
        <p>
          You are responsible for ensuring your use of Pocketlytics complies with all applicable privacy laws and regulations
          in your jurisdiction. You must obtain any necessary consents from your website visitors as required by law.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Intellectual Property</h2>
        <p>
          The Pocketlytics name, logo, and branding are property of Pocketlytics. The open-source code is available under the AGPL 3.0
        ...
        <p>
          To the maximum extent permitted by law, Pocketlytics and its contributors shall not be liable for any indirect,
        ...
        <p>
          You agree to indemnify and hold harmless Pocketlytics and its contributors from any claims, damages, losses,
        ...
        <p>
          These Terms, along with our Privacy Policy, constitute the entire agreement between you and Pocketlytics regarding
        ...
        <p>
          ...
          <a href="https://www.pocketlytics.local/contact" className="text-emerald-400 hover:text-emerald-300 ml-1">

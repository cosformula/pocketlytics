...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Is Pocketlytics GDPR and CCPA compliant?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, Pocketlytics is fully compliant with GDPR, CCPA, and other privacy regulations. We don't use cookies or collect any personal data that could identify your users. We salt user IDs daily to ensure users are not fingerprinted. You will not need to display a cookie consent banner to your users.",
      },
    },
    {
      "@type": "Question",
      name: "How does Pocketlytics compare to Google Analytics?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pocketlytics is much less bloated than Google Analytics, both in terms of our tracking script and the UX of the dashboard. We show you exactly what you need to see. The difference in usability is night and day.",
      },
    },
    {
      "@type": "Question",
      name: "Can I self-host Pocketlytics?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! Pocketlytics is available as a self-hosted option. You can install it on your own server and have complete control over your data. We also offer a cloud version if you prefer a managed solution.",
      },
    },
    {
      "@type": "Question",
      name: "How easy is it to set up Pocketlytics?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Setting up Pocketlytics is incredibly simple. Just add a small script to your website or install @pocketlytics/js from npm, and you're good to go. Most users are up and running in less than 5 minutes.",
      },
    },
    {
      "@type": "Question",
      name: "What platforms does Pocketlytics support?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pocketlytics works with virtually any website platform. Whether you're using WordPress, Shopify, Next.js, React, Vue, or any other framework, our simple tracking snippet integrates seamlessly.",
      },
    },
    {
      "@type": "Question",
      name: "Is Pocketlytics truly open source?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, Pocketlytics is 100% open source. Every single line of code, including for our cloud/enterprise offerings, is available on GitHub under the AGPL 3.0 license.",
      },
    },
  ],
};
...
export const metadata = {
  title: "Pocketlytics - Cookieless Google Analytics Replacement",
  description:
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center overflow-x-hidden pt-16 md:pt-24">
        ...
        <h2 className="text-base md:text-xl pt-4 md:pt-6 px-4 tracking-tight max-w-4xl text-center text-neutral-600 dark:text-neutral-300 font-light">
          Pocketlytics is powerful, lightweight, and super easy to use analytics. Cookieless and GDPR compliant. Hosted on EU
        ...
        <div className="flex flex-col items-center my-8 md:my-10">
          <div className="flex flex-row items-center justify-center gap-4 md:gap-6 text-base md:text-lg">
            ...
            <TrackedButton
              href="https://demo.pocketlytics.local/81"
              eventName="demo"
              target="_blank"
        ...
        <div className="relative w-full max-w-[1300px] mb-10">
          ...
          <div className="relative z-10 rounded-2xl overflow-hidden bg-neutral-400/10 dark:bg-neutral-100/5 border-8 shadow-2xl shadow-neutral-900/20 dark:shadow-emerald-900/10">
            ...
            <iframe
              src="https://demo.pocketlytics.local/81/main"
              width="1300"
              height="750"
              className="w-full h-[600px] md:h-[700px] lg:h-[750px] rounded-xl"
              style={{ border: "none" }}
              title="Pocketlytics Analytics Demo"
            ></iframe>
          </div>
        </div>
        ...
        <section className="py-14 md:py-20 w-full max-w-[1200px] px-4">
          <div className="text-center mb-10 md:mb-12">
            <SectionBadge className="mb-4">Why Pocketlytics</SectionBadge>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-16">
              <div className="md:sticky md:top-24 md:self-start">
                ...
                <p className="mt-4 text-neutral-600 dark:text-neutral-300 font-light">
                  Integrate Pocketlytics with any platform in minutes
                </p>
              </div>
              <IntegrationsGrid />
            </div>
        ...
        <section className="py-10 md:py-16 w-full overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="text-center mb-10 md:mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight">People love Pocketlytics</h2>
              <p className="mt-4 text-base md:text-xl text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto font-light">
                See what others think about Pocketlytics Analytics
              </p>
            </div>
          ...
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-16">
              <div className="md:sticky md:top-24 md:self-start">
                ...
                <p className="mt-4 text-neutral-600 dark:text-neutral-300 font-light">
                  Everything you need to know about Pocketlytics Analytics
                </p>
              </div>
              <FAQAccordion />
            </div>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/analytics-detector",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/analytics-detector",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "@id": "https://pocketlytics.local/tools/analytics-detector",
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Privacy-focused analytics tools like Pocketlytics, Fathom, Plausible, and Shynet don't use cookies, don't track users across sites, and are GDPR compliant by default. These alternatives provide valuable insights without compromising user privacy or requiring cookie banners.",
          },
        },
        {
          "@type": "Question",
  ...
  <>
    <section>
      ...
      <ul className="list-disc list-inside space-y-2 text-neutral-700 dark:text-neutral-300 ml-4">
        ...
        <li>
          <strong>Privacy-focused alternatives</strong> - Pocketlytics, Plausible, Fathom Analytics that prioritize user
          privacy
        </li>
        <li>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <Link href="https://pocketlytics.local" className="text-emerald-600 dark:text-emerald-400 hover:underline">
          Pocketlytics
        </Link>
...
export default function AnalyticsDetectorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Privacy-first analytics with Pocketlytics"

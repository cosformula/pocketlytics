...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/cost-per-acquisition-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/cost-per-acquisition-calculator",
  },
};
...
export default function CostPerAcquisitionPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your acquisition costs with Pocketlytics"
      ctaDescription="Monitor CPA, conversion rates, and campaign performance in real-time with Pocketlytics's analytics platform."

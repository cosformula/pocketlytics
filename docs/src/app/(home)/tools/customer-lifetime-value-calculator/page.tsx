...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/customer-lifetime-value-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/customer-lifetime-value-calculator",
  },
};
...
export default function CustomerLifetimeValuePage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track CLV and customer metrics with Pocketlytics"
      ctaDescription="Monitor customer lifetime value, retention cohorts, and revenue trends in real-time with Pocketlytics's analytics platform."

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/og-tag-generator",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/og-tag-generator",
  },
};
  ...
  <>
    ...
    <ol className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      ...
      <li>
        ...
        <Link
          href="https://app.pocketlytics.local"
...
export default function OGTagGeneratorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your social media traffic with Pocketlytics"

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/seo-title-generator",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/seo-title-generator",
  },
};
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Use analytics to track CTR from search results. Tools like Pocketlytics can show you which pages get the most organic traffic, helping you identify successful titles and opportunities for improvement.",
          },
        },
        {
          "@type": "Question",
...
export default function SEOTitleGeneratorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your SEO performance with Pocketlytics"

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/funnel-visualizer",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/funnel-visualizer",
  },
};
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Optimize high drop-off steps first by: simplifying forms and checkout processes, improving page load speed, enhancing trust signals and social proof, clarifying value propositions, reducing friction (fewer clicks), improving mobile experience, A/B testing changes, and removing distractions. Track these improvements with Pocketlytics Analytics to measure the actual impact on conversions.",
          },
        },
      ],
    },
...
export default function FunnelVisualizerPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track funnels automatically with Pocketlytics"
      ctaDescription="No manual data entry—Pocketlytics automatically tracks conversion funnels with real-time session data."

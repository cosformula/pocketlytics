...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/bounce-rate-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/bounce-rate-calculator",
  },
};
...
export default function BounceRateCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track bounce rate in real-time with Pocketlytics"

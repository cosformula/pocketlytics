...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/retention-rate-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/retention-rate-calculator",
  },
};
...
export default function RetentionRatePage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track retention metrics with Pocketlytics"
      ctaDescription="Monitor retention rates, churn patterns, and customer behavior in real-time with Pocketlytics's analytics platform."

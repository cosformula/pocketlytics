...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/cost-per-view-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/cost-per-view-calculator",
  },
};
...
export default function CostPerViewPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track CPV and video metrics with Pocketlytics"
      ctaDescription="Monitor cost per view, video engagement, and campaign performance across all platforms in real-time with Pocketlytics."

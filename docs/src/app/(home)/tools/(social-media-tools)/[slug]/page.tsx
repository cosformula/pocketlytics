...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug.endsWith("-photo-resizer")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-photo-resizer`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-photo-resizer`,
      },
    };
  }
  ...
  if (slug.endsWith("-bio-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-bio-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-bio-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-character-counter")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-character-counter`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-character-counter`,
      },
    };
  }
  ...
  if (slug.endsWith("-hashtag-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-hashtag-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-hashtag-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-username-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-username-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-username-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-post-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-post-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-post-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-page-name-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-page-name-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-page-name-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-comment-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-comment-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-comment-generator`,
      },
    };
  }
  ...
  if (slug.endsWith("-logo-generator")) {
    ...
    return {
      ...
      openGraph: {
        ...
        description: platform.description,
        type: "website",
        url: `https://pocketlytics.local/tools/${platform.id}-logo-generator`,
        siteName: "Pocketlytics Documentation",
      },
      twitter: {
        card: "summary_large_image",
      ...
      alternates: {
        canonical: `https://pocketlytics.local/tools/${platform.id}-logo-generator`,
      },
    };
  }
  ...
  return {
    ...
    openGraph: {
      ...
      description: platform.description,
      type: "website",
      url: `https://pocketlytics.local/tools/${platform.id}-font-generator`,
      siteName: "Pocketlytics Documentation",
    },
    twitter: {
      card: "summary_large_image",
    ...
    alternates: {
      canonical: `https://pocketlytics.local/tools/${platform.id}-font-generator`,
    },
  };
}
...
export default async function PlatformToolPage({ params }: PageProps) {
  ...
  if (slug.endsWith("-photo-resizer")) {
    ...
    return (
      <ToolPageLayout
        ...
        ctaTitle={`Enhance your ${platform.name} visuals with Pocketlytics`}
  ...
  if (slug.endsWith("-bio-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me grow on social media?",
        answer: (
          <>
            Once you have a great bio, Pocketlytics helps you track engagement, clicks, and growth on {platform.name}.
            Understand what content resonates with your audience and optimize your strategy.{" "}
            <a href="https://pocketlytics.local" className="text-emerald-600 hover:text-emerald-500 underline">
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Build your ${platform.name} presence with Pocketlytics`}
  ...
  if (slug.endsWith("-character-counter")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me track my social media performance?",
        answer: (
          <>
            Pocketlytics helps you track engagement, clicks, and performance of your {platform.name} posts. See which content
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Track your ${platform.name} performance with Pocketlytics`}
  ...
  if (slug.endsWith("-hashtag-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me track hashtag performance?",
        answer: (
          <>
            Pocketlytics helps you measure which content and hashtags drive the most engagement on {platform.name}. Track
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Optimize your ${platform.name} hashtag strategy with Pocketlytics`}
  ...
  if (slug.endsWith("-username-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me grow my presence?",
        answer: (
          <>
            Once you've claimed your username, Pocketlytics helps you track engagement, clicks, and growth on {platform.name}.
  ...
  if (slug.endsWith("-post-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me measure post performance?",
        answer: (
          <>
            Pocketlytics tracks clicks, engagement, and traffic from your {platform.name} posts. See which content drives the
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Optimize your ${platform.name} strategy with Pocketlytics`}
  ...
  if (slug.endsWith("-page-name-generator")) {
    ...
    const faqs = [
      ...
      },
      {
        ...
        answer: (
          <>
            Pocketlytics helps you track engagement, clicks, and traffic sources from your {platform.name} presence.
            Understand what content resonates with your audience and optimize your strategy.{" "}
            <a href="https://pocketlytics.local" className="text-emerald-600 hover:text-emerald-500 underline">
              Start tracking for free
            </a>
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Grow your ${platform.name} presence with Pocketlytics`}
  ...
  if (slug.endsWith("-comment-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help me track comment engagement?",
        answer: (
          <>
            Pocketlytics helps you measure which content drives the most engagement and comments on your social media. Track
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle="Track engagement and comment activity with Pocketlytics"
  ...
  if (slug.endsWith("-logo-generator")) {
    ...
    const faqs = [
      ...
      {
        question: "How can Pocketlytics help with my brand?",
        answer: (
          <>
            Pocketlytics helps you track your brand&apos;s performance across social media platforms. Monitor how your brand is
            discovered, track engagement, and understand your audience.{" "}
            <a
              href="https://app.pocketlytics.local/signup"
    ...
    return (
      <ToolPageLayout
        ...
        faqs={faqs}
        relatedToolsCategory="social-media"
        ctaTitle={`Build your ${platform.name} brand presence with Pocketlytics`}
  ...
  const fontFaqs = [
    ...
    },
    {
      ...
      answer: (
        <>
          Pocketlytics helps you track clicks, engagement, and traffic sources from your {platform.name} posts and bio links.
  ...
  return (
    <ToolPageLayout
      ...
      faqs={fontFaqs}
      relatedToolsCategory="social-media"
      ctaTitle="Track your social media engagement with Pocketlytics"

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/cost-per-mille-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/cost-per-mille-calculator",
  },
};
...
export default function CostPerMillePage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track CPM and ad performance with Pocketlytics"
      ctaDescription="Monitor CPM, impressions, and campaign metrics across all platforms in real-time with Pocketlytics's analytics."

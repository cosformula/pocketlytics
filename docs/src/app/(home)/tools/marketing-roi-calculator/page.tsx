...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/marketing-roi-calculator",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/marketing-roi-calculator",
  },
};
...
export default function MarketingROICalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your marketing ROI with Pocketlytics"

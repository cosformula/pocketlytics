...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/cost-per-lead-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/cost-per-lead-calculator",
  },
};
...
export default function CostPerLeadPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track CPL and lead metrics with Pocketlytics"
      ctaDescription="Monitor cost per lead, lead quality, and channel performance in real-time with Pocketlytics's analytics platform."

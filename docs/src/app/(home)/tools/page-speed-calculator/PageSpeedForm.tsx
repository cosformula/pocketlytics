          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-5" className="border-b-0">
              ...
              <AccordionContent>
                ...
                experience. Tools like Pocketlytics are designed to minimize this impact with lightweight asynchronous loading
      ...
      <div className="border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto">
            Pocketlytics's tiny 3KB script loads asynchronously and won't impact your page speed. Get started for free with up

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/page-speed-calculator",
    siteName: "Pocketlytics",
    images: [
      {
        url: "https://pocketlytics.local/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://pocketlytics.local/og-image.png"],
  },
  alternates: {
    canonical: "https://pocketlytics.local/tools/page-speed-calculator",
  },
};
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Many analytics tools can significantly impact page performance by loading large scripts synchronously and making blocking network requests. Tools like Pocketlytics are designed to minimize this impact with lightweight asynchronous loading.",
          },
        },
      ],
    },
...
const educationalContent = (
  <>
    ...
    <ul className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      ...
      <li>
        <strong>Tool Selection:</strong> Choose lightweight tools like Pocketlytics (3KB) instead of heavyweight analytics
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        blocking network requests. Tools like Pocketlytics are designed to minimize this impact with lightweight asynchronous
        loading.
      </>
    ),
  },
...
export default function PageSpeedCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Optimize your site speed with Pocketlytics"
      ctaDescription="Pocketlytics is a lightweight analytics solution (3KB) that won't slow down your site. Monitor performance while maintaining fast load times."

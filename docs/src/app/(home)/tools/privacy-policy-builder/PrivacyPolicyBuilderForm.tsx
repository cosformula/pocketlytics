...
*This privacy policy was generated using ${websiteUrl.includes("pocketlytics") ? "Pocketlytics's" : "[Pocketlytics's](https://pocketlytics.local)"} Privacy Policy Builder. For compliance with specific regulations (GDPR, CCPA, etc.), please consult with a legal professional.*`;
  };
        ...
        <div className="space-y-3 pt-4 border-t border-neutral-200 dark:border-neutral-800">
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <div>
              ...
              <div className="text-xs text-neutral-600 dark:text-neutral-400">
                Google Analytics, Pocketlytics, Plausible, etc.
              </div>
            </div>
          </label>
      ...
      <div className="border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 py-20 -mx-6 mt-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 dark:text-white mb-4">
            Privacy-first analytics with Pocketlytics
          </h2>

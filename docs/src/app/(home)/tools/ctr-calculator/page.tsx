...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/ctr-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/ctr-calculator",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "@id": "https://pocketlytics.local/tools/ctr-calculator#webapp",
      name: "CTR Calculator",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://pocketlytics.local/tools/ctr-calculator#faqpage",
      mainEntity: [
        {
          "@type": "Question",
...
export default function CTRCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your campaign performance with Pocketlytics"

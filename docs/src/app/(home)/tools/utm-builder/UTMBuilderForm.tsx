        ...
        <div className="bg-neutral-100/50 dark:bg-neutral-800/20 backdrop-blur-sm border border-neutral-300/50 dark:border-neutral-800/50 rounded-xl overflow-hidden">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger>How do I track UTM links with Pocketlytics?</AccordionTrigger>
              <AccordionContent>
                Once you have Pocketlytics installed on your website, UTM parameters are automatically tracked. You can view your campaign performance in your{" "}
                <Link href="https://app.pocketlytics.local" className="text-emerald-600 dark:text-emerald-400 hover:underline">
                  Pocketlytics dashboard
                </Link>{" "}

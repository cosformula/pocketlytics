...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/utm-builder",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/utm-builder",
  },
};
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "UTM (Urchin Tracking Module) parameters are tags added to URLs that help you track the effectiveness of your marketing campaigns in analytics tools like Pocketlytics, Google Analytics, and others. They tell you exactly where your traffic is coming from and how your campaigns perform.",
          },
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          name: "How do I track UTM links with Pocketlytics?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Once you have Pocketlytics installed on your website, UTM parameters are automatically tracked. You can view your campaign performance in your Pocketlytics dashboard under the UTM section.",
          },
        },
        {
          "@type": "Question",
...
const educationalContent = (
  <>
    ...
    <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
      ...
      campaign performance. When someone clicks a link with UTM parameters, analytics tools like Pocketlytics, Google
...
const faqs = [
  {
    ...
    answer:
      "UTM (Urchin Tracking Module) parameters are tags added to URLs that help you track the effectiveness of your marketing campaigns in analytics tools like Pocketlytics, Google Analytics, and others. They tell you exactly where your traffic is coming from and how your campaigns perform.",
  },
  {
  ...
  {
    question: "How do I track UTM links with Pocketlytics?",
    answer:
      "Once you have Pocketlytics installed on your website, UTM parameters are automatically tracked. You can view your campaign performance in your Pocketlytics dashboard under the UTM section.",
  },
  {
...
export default function UTMBuilderPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your UTM campaigns with Pocketlytics"

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/traffic-value-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/traffic-value-calculator",
  },
};
...
export default function TrafficValueCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Maximize your traffic value with Pocketlytics"

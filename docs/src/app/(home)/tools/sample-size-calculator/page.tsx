...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/sample-size-calculator",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/sample-size-calculator",
  },
};
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Your baseline conversion rate is your current control variant's conversion rate. If you're testing a website redesign and currently 2.5% of visitors convert, use 2.5% as your baseline. You can get this from your analytics tools (Google Analytics, Pocketlytics Analytics, etc.). Use your most recent data that's representative of normal traffic. Seasonal variations and traffic changes can affect your baseline, so update it if conditions change significantly. More accurate baselines lead to more realistic sample size calculations.",
          },
        },
      ],
    },
...
const educationalContent = (
  <>
    ...
    <ol className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      <li>
        <strong>Enter Your Baseline Conversion Rate:</strong> Get this from your analytics (Google Analytics, Pocketlytics,
      ...
      <li>
        ...
        visitors needed, and estimated test duration. Use Pocketlytics Analytics to monitor progress and track when you reach
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <Link href="https://app.pocketlytics.local" className="text-emerald-600 dark:text-emerald-400 hover:underline">
          Pocketlytics Analytics
        </Link>{" "}
...
export default function SampleSizeCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Run better A/B tests with Pocketlytics"

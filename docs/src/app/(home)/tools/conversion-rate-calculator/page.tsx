...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://pocketlytics.local/tools/conversion-rate-calculator",
  ...
  alternates: {
    canonical: "https://pocketlytics.local/tools/conversion-rate-calculator",
  },
};
...
export default function ConversionRatePage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track conversion rates with Pocketlytics"
      ctaDescription="Monitor conversion rates across pages, campaigns, and channels in real-time with Pocketlytics's analytics platform."

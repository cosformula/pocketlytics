export const metadata = {
  title: "Security",
  description: "Pocketlytics security practices and data protection",
};
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        <p className="text-lg mb-8">
          Security and privacy are at the core of everything we do at Pocketlytics. Here's how we protect your data and
        ...
        <p>
          Pocketlytics is hosted on Hetzner servers located in Germany, within the European Union. Hetzner is ISO 27001
        ...
        <p>Pocketlytics is fully open source, which means:</p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p>Pocketlytics is designed to help you comply with privacy regulations:</p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p>If you discover a security vulnerability in Pocketlytics, please report it responsibly:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Email us at{" "}
            <a href="mailto:hello@pocketlytics.local" className="text-emerald-400 hover:text-emerald-300">

export const metadata = {
  ...
  description: "Pocketlytics privacy policy - how we protect your data",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          Pocketlytics is an open-source, privacy-friendly web analytics alternative to Google Analytics. This privacy policy
        ...
        <p>Pocketlytics collects the following anonymous data about website visits:</p>
        ...
        <p>
          Pocketlytics uses anonymous session and user identifiers that contain no personally identifiable information. These
        ...
        <p>
          Unlike traditional analytics tools, Pocketlytics functions without cookies. This means websites using Pocketlytics
        ...
        <p>
          For self-hosted Pocketlytics instances, all collected data remains exclusively on your servers and under your
        ...
        <p>Pocketlytics is designed with privacy regulations in mind, including GDPR, CCPA, and ePrivacy Directive:</p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p>
          ...
          <a href="https://github.com/cosformula/pocketlytics" className="text-emerald-400 hover:text-emerald-300 ml-1">
        ...
        <p>
          If you have questions about this privacy policy or Pocketlytics&apos;s data practices, please contact us at:

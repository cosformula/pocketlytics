    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          minimalism and efficiency. Pocketlytics takes a different approach: while our script is larger at 18KB, it's because
          we've packed in powerful features like session replay, error tracking, and advanced user analytics. Think of
          it this way: Umami is a bicycle - efficient, simple, gets you there. Pocketlytics is an electric bike - still easy
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Both Pocketlytics and Umami share the same DNA: privacy-focused, cookie-free, GDPR-compliant analytics that respect
          ...
          community wins either way. The difference is that Pocketlytics goes further with features like daily rotating salt
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Umami tells you what happened. Pocketlytics shows you exactly how it happened. Our session replay feature is the
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          While Umami recently added funnels and journey reports, Pocketlytics goes several steps further. We offer
          ...
          visualization. Umami focuses on being a simple Google Analytics alternative. Pocketlytics aims to be a complete
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          capabilities. Pocketlytics offers 2-5+ years of data retention depending on your plan, powered by ClickHouse, the
          ...
          events, Pocketlytics maintains sub-second query performance. This isn't just about handling more data - it's about
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics offers both robust self-hosting options and a mature managed cloud service with a generous free tier of
          ...
          operational overhead, Pocketlytics provides the best of both worlds.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          web analytics. It does that job admirably. Pocketlytics is built for teams that need more: product analytics, user
          ...
          e-commerce platform, or any application where understanding user behavior deeply matters, Pocketlytics provides the
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Choosing between Umami and Pocketlytics isn't about which is "better" - it's about what you need. Umami is excellent
          for basic analytics with minimal overhead. Pocketlytics is designed for teams that need comprehensive insights
          ...
          keeps things simple, we've proven you can have powerful features and still maintain ease of use. With Pocketlytics,

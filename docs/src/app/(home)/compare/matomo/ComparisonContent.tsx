    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          configurations. Pocketlytics takes the opposite approach: we provide powerful analytics through a beautifully simple
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          interface feels dated, the script is heavy (20-50KB), and it requires constant maintenance and updates. Pocketlytics
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          careful testing. Pocketlytics is privacy-compliant from the moment you install it. No cookies, no personal data
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          you're responsible for backups and disaster recovery. With Pocketlytics's cloud service, we handle everything. No
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          essentials like user journey visualization, Web Vitals monitoring, and a real-time globe view. Pocketlytics focuses
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          cloud offering is limited and expensive, starting at €19/month for just 50k pageviews. Pocketlytics offers generous
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          dependency, and complex setup process reflect web development practices from 15 years ago. Pocketlytics is built for
          ...
          massive datasets. When you choose Pocketlytics, you're choosing technology that matches your modern development
          stack.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          complex documentation. With Pocketlytics, you can explore a live demo with real data immediately. See the interface,

    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          SimpleAnalytics and Pocketlytics share the same core mission: provide privacy-friendly analytics without cookies or
          ...
          things minimal with basic web analytics, Pocketlytics proves you can have both privacy and power. We offer session
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          without verification. Pocketlytics is fully open source (AGPL v3) with 8000+ GitHub stars. You can inspect every
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          businesses need deeper insights. Pocketlytics's session replay shows you exactly how users interact with your site,
          ...
          user profiles track behavior over time. While SimpleAnalytics gives you surface-level metrics, Pocketlytics provides
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          SimpleAnalytics works well for blogs and content sites that need basic visitor metrics. Pocketlytics is designed for
          ...
          products and teams from one dashboard. If you're building a product rather than publishing content, Pocketlytics
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          are doing, Pocketlytics shows you with session replay. Instead of AI-generated insights about conversion rates, our
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          serious analysis. Pocketlytics's free tier provides {DEFAULT_EVENT_LIMIT.toLocaleString()} pageviews per month with
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          SimpleAnalytics uses Node.js and PostgreSQL, a solid but traditional stack. Pocketlytics leverages Next.js,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Both Pocketlytics and SimpleAnalytics are bootstrapped companies fighting against surveillance capitalism. We
          respect their commitment to privacy and transparency. But we believe users shouldn't have to choose between
          simplicity and functionality. Pocketlytics maintains the same clean, intuitive interface that makes SimpleAnalytics

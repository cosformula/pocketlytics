    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          and closed source. This fundamental difference matters. With Pocketlytics's open source approach (AGPL v3), you can
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          modern businesses need more than pageview counts and referrer data. Pocketlytics provides the advanced features that
          ...
          performance tracking, and browser error tracking to catch issues. While Fathom tells you what happened, Pocketlytics
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          analytics, newsletter tracking, and content performance. Pocketlytics is built for product teams who need deeper
          ...
          application, Pocketlytics provides the tools you actually need, not just the basics.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Fathom's Go and MySQL stack is solid but traditional. Pocketlytics leverages Next.js, TypeScript, and ClickHouse,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Both Pocketlytics and Fathom are privacy-first, cookie-free, and GDPR compliant. We both store data in EU servers
          and never sell user information. But Pocketlytics goes further with our daily rotating salt option for enhanced
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          $15/month with no free tier. Pocketlytics believes analytics should be accessible to everyone, offering
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          take-it-or-leave-it proposition. Pocketlytics gives you choices. Run our cloud service for zero maintenance.
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Fathom offers a 7-day trial, but you need to implement tracking before seeing their interface. Pocketlytics provides
          ...
          why thousands of developers choose Pocketlytics. We're not just an alternative to Fathom; we're the evolution of

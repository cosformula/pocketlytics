    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          like UTM tracking, events, goals, or session tracking. Pocketlytics is a dedicated analytics platform where every
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          multiple "unique" visitors if they come from different sources, massively inflating your numbers. Pocketlytics
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          you're flying blind on engagement. Pocketlytics provides all these essentials plus advanced features like session
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          need to switch providers. Pocketlytics keeps your data for years and provides full data export capabilities. Your
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          out of luck. Pocketlytics works with any website, anywhere. Just add one line of JavaScript. No DNS changes, no
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          mobile support, and no customer support. Pocketlytics is built for real businesses: unlimited data views, team
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          code, and can't customize anything. Pocketlytics is proudly open source (AGPL v3) with thousands of GitHub stars.
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          For Cloudflare, web analytics is a minor feature to complement their CDN business. For Pocketlytics, analytics is
          ...
          independently bootstrapped and deeply invested in making the product better every day. When you choose Pocketlytics,

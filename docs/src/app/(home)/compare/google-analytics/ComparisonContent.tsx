    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          The fundamental difference between Pocketlytics and Google Analytics lies in our approach to privacy. While Google
          Analytics collects vast amounts of personal data requiring cookie consent banners to comply with GDPR and
          CCPA, Pocketlytics is built privacy-first. We don't use cookies, don't track personal information, and are compliant
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics fills this gap perfectly: we provide comprehensive features including session replay, user profiles,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics's lightweight script loads from a global CDN, ensuring minimal impact on your site's performance while
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          15-30% of your visitors. Pocketlytics gives you 100% accurate, real-time data with no sampling ever. We're less
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          While Google Analytics shows you what happened through numbers and charts, Pocketlytics provides a comprehensive
          ...
          visitor activity. Features like public dashboards and organization support make Pocketlytics perfect for agencies
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics is open source (AGPL v3) with thousands of stars on GitHub, meaning you can inspect our code,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Google Analytics is "free" because you're the product. Your data feeds their advertising empire. Pocketlytics has a
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Unlike Google Analytics where you need to implement tracking before seeing any interface, Pocketlytics offers a live

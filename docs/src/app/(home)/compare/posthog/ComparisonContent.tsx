    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          department. That's where Pocketlytics shines. We've taken the best parts of advanced analytics and wrapped them in
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          overwhelming. Their interface looks like an IDE, not an analytics tool. Pocketlytics takes the opposite approach: we
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          GDPR compliance. Pocketlytics is privacy-first by design. No cookies ever. No personal data collection. GDPR
          ...
          have to trust that you configured your analytics correctly. With Pocketlytics, privacy isn't optional, it's
          guaranteed.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          They're good at many things but excellent at none. Pocketlytics focuses exclusively on being the world's best web
          ...
          faster. While PostHog users struggle with complex configurations and scattered features, Pocketlytics users are
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          jumping from $0 to $2,000/month overnight. Pocketlytics keeps it simple: pay for events, get everything included. No
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          powerful but heavy, potentially impacting your site's performance and your Core Web Vitals scores. Pocketlytics's
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics is built for everyone. Our interface is so intuitive that new users understand it within minutes. No
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          everything to everyone. Pocketlytics is proudly bootstrapped. We answer to our customers, not investors. This means
          we can focus on building the best product instead of the biggest product. We can keep prices fair instead of
          maximizing revenue. We can say no to feature bloat and yes to polish and refinement. When you choose Pocketlytics,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          without the complexity, Pocketlytics is the clear choice. We've proven you don't need to sacrifice power for

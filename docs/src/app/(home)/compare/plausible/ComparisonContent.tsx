    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          while Plausible stops at basic web analytics, Pocketlytics goes much further. We've added session replay, funnels,
          user journeys, detailed user profiles, Web Vitals monitoring, and error tracking, all while maintaining the
          same ease of use. You don't have to choose between simplicity and functionality. With Pocketlytics, you get both.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Both Pocketlytics and Plausible share the same core values: respect user privacy, avoid cookies, and comply with
          ...
          sides here. We're fighting the same fight against surveillance capitalism. The difference is that Pocketlytics
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Plausible tells you what pages users visit. Pocketlytics shows you how they actually interact with those pages. Our
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Pocketlytics answers those questions too, but we also serve product teams. Track custom events with attributes,
          ...
          While Plausible is great for content sites and blogs, Pocketlytics is built for SaaS products, e-commerce platforms,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          organization-level features. Pocketlytics provides full organization support, allowing you to manage multiple
          ...
          you're tracking one website or one hundred, Pocketlytics grows with you without compromising performance or
          simplicity.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          accessible to everyone, which is why Pocketlytics offers a generous free tier with{" "}
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Choosing Pocketlytics doesn't mean rejecting what Plausible stands for. We share their commitment to privacy,
          ...
          fun. Our session replay makes debugging easier. Our funnels help you optimize conversions. Think of Pocketlytics as
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          interface that makes Plausible-style analytics so appealing. When you choose Pocketlytics, you're not just getting

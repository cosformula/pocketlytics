...
export const metadata: Metadata = {
  title: "Blog",
  description: "Latest updates and insights from Pocketlytics",
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <div className="mb-12">
        ...
        <p className="text-xl text-neutral-600 dark:text-neutral-400">Latest updates, tutorials, and insights from the Pocketlytics team</p>
      </div>

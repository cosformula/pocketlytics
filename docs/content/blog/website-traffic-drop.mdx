...
date: 2025-06-08
description: Find out why your website traffic dropped using Pocketlytics
...
To properly investigate what's going on, you'll need a solid analytics tool with [web analytics capabilities](/blog/what-is-web-analytics) to understand traffic patterns and [bounce rate analysis](/blog/bounce-rate) to identify engagement issues. We obviously recommend Pocketlytics (and we'll show you exactly how to use it), plus you'll want access to an SEO tool and Google Search Console. By walking through Pocketlytics's specific features, we'll show you how to diagnose what's actually causing your traffic to tank.
...
First, take a look at the amount of traffic that has dropped. You can use the main tab on Pocketlytics to find this information: 

Head to your [main tab](https://demo.pocketlytics.local/1/main) in Pocketlytics and start looking at different time periods:
...
<img src="/blog/main.png" alt="Pocketlytics's main dashboard" />
...
If your sales funnel pages are seeing drops, check our [sales funnel guide](/blog/what-is-sales-funnel-pocketlytics) to understand the impact on conversions.
...
#### Using Pocketlytics to investigate:

Pocketlytics has several great features that allow you to investigate potential technical issues that could be causing your website to drop in traffic:
...
Once you have identified if the drop is truly a drop and pages have been affected, you should start looking for any patterns in geographics or devices, use Pocketlytics's filter function to filter on device type as well as country:

<img src="/blog/countryfilter.png" alt="Pocketlytics's country filter" />
(Using Pocketlytics to filter for a specific country)

<img src="/blog/devicefilter.png" alt="Pocketlytics's device filter" />

(Using Pocketlytics to filter for a specific device type).  
...
**Using Pocketlytics to spot technical issues:**
...
Traffic drops are a natural part of website ownership, but they don't have to be devastating. With the right investigative approach using tools like Pocketlytics, you can quickly identify the causes and take corrective action.

Remember that Pocketlytics's strength lies in its detailed page-level analytics and performance monitoring capabilities. For longer-term health, also track [retention and churn metrics](/blog/churn-rate-vs-retention-rate) to ensure recovered traffic actually converts to engaged users.
...
2. **Use data** \- Let Pocketlytics's analytics guide your investigation rather than making assumptions  

...
The data import feature allows you to migrate your historical analytics data from other platforms to Pocketlytics. This preserves your analytics history when switching from competitors, giving you a complete view of your data without losing valuable insights.
...
Currently, Pocketlytics supports importing data from:
...
1. Open your Pocketlytics dashboard
...
- Continue using Pocketlytics while the import runs
...
**Imported Events**
- Number of events successfully imported into Pocketlytics

...
Generate API keys to access Pocketlytics's analytics endpoints from your applications.
...
Include your API key in requests to Pocketlytics's API endpoints. See the [API documentation](/docs/api) for available endpoints and usage examples.

...
description: Authentication, common parameters, and best practices for the Pocketlytics Stats API
---
...
The easiest way to explore and test the API is using the built-in **API Playground** in your Pocketlytics dashboard. Access it by navigating to any site and clicking "API Playground" in the sidebar.

...
description: Advanced configuration options for self-hosting Pocketlytics
---

import { Callout } from 'fumadocs-ui/components/callout';


This guide covers advanced configuration options for self-hosting Pocketlytics.

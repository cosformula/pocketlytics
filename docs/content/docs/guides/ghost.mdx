---
title: Ghost
description: Integrate Pocketlytics Analytics with your Ghost blog or publication
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Ghost is a powerful publishing platform for blogs and publications. You can easily add Pocketlytics Analytics using Ghost's built-in code injection feature.

## How to Add Pocketlytics to Ghost
...
3. Check "View Page Source" and search for `pocketlytics` to verify the script is present
...
Ghost's membership features work normally with Pocketlytics. All page views, including member-only content, will be tracked (for visitors who have access to view the content).

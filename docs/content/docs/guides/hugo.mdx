---
title: Hugo
description: Integrate Pocketlytics Analytics with your Hugo static site using partial templates
---

import { Steps, Step } from 'fumadocs-ui/components/steps';

Integrating Pocketlytics Analytics with your Hugo static site involves adding the tracking script to your site's templates. The best way to do this is by creating a partial template for the script and including it in your site's footer.
...
Inside `layouts/partials/`, create a new file named `pocketlytics-analytics.html` (or a similar name).

Paste your Pocketlytics tracking script into this new file:

```html
{{/* layouts/partials/pocketlytics-analytics.html */}}
...
- Replace `https://app.pocketlytics.local` and `YOUR_SITE_ID` with your actual details.
</Step>
...
Open your main base template or footer partial file. Just before the closing `</body>` tag, add the following line to include your Pocketlytics Analytics partial:

```html
{{/* ... other footer content ... */}}

{{ partial "pocketlytics-analytics.html" . }}
...
<Steps>
<Step>
### Update `pocketlytics-analytics.html`

Modify `layouts/partials/pocketlytics-analytics.html` to use a site parameter:

```html
{{/* layouts/partials/pocketlytics-analytics.html */}}
{{ if and (not .Site.IsServer) .Site.Params.pocketlyticsSiteID }}
  <script async defer src="{{ .Site.Params.pocketlyticsInstanceURL | default "https://app.pocketlytics.local" }}/api/script.js" data-site-id="{{ .Site.Params.pocketlyticsSiteID }}"></script>
{{ end }}
```
</Step>
...
```toml
[params]
  pocketlyticsInstanceURL = "https://app.pocketlytics.local" # Your Pocketlytics instance URL
  pocketlyticsSiteID = "YOUR_SITE_ID" # Your Pocketlytics Site ID
```
...
That's it! Pocketlytics Analytics is now integrated with your Hugo site and will only track visits on your production deployment.
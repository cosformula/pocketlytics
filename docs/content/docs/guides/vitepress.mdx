---
title: VitePress
description: Integrate Pocketlytics Analytics with your VitePress documentation site
---

import { Tabs, Tab } from 'fumadocs-ui/components/tabs';
import { Callout } from 'fumadocs-ui/components/callout';

VitePress is a static site generator powered by Vite and Vue, commonly used for documentation. Here's how to add Pocketlytics Analytics to your VitePress site.

## How to Add Pocketlytics to VitePress

<Tabs items={['Config File (Recommended)', 'Custom Theme']}>
<Tab>
### Using VitePress Config

The simplest way to add Pocketlytics is through your VitePress configuration file.
...
VitePress uses client-side navigation between pages. The Pocketlytics script automatically tracks page views during SPA navigation, so no additional configuration is needed.

---
title: BigCommerce
description: Integrate Pocketlytics Analytics with your BigCommerce store
---
...
BigCommerce is a leading e-commerce platform for online stores. You can integrate Pocketlytics Analytics to track visitor behavior and conversions.

## How to Add Pocketlytics to BigCommerce

<Tabs items={['Script Manager (Recommended)', 'Theme Files']}>
<Tab>
### Using Script Manager

The easiest way to add Pocketlytics to BigCommerce is through the Script Manager.
...
- **Name**: Pocketlytics Analytics
- **Description**: Pocketlytics Analytics tracking script
- **Placement**: Head
- **Location**: All pages
...
To get the most out of Pocketlytics with BigCommerce, you can track key e-commerce events like product views and purchases.
...
<script>
(function() {
  function waitForPocketlytics(callback, timeout) {
    var start = Date.now();
    (function check() {

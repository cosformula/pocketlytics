---
title: "Squarespace"
description: "Integrate Pocketlytics Analytics with your Squarespace website using the Code Injection feature."
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from "fumadocs-ui/components/callout";

Integrating Pocketlytics Analytics with your Squarespace website is straightforward. You'll need to use Squarespace's "Code Injection" feature to add the Pocketlytics tracking script to your site.
...
For sitewide tracking, paste your Pocketlytics tracking script into the **Footer** text area. This ensures the script loads after your page content, which is generally better for perceived page load performance.
...
Once you've saved the changes, Pocketlytics Analytics should start tracking visitors on your Squarespace site.
...
That's it! Pocketlytics Analytics is now integrated with your Squarespace website.
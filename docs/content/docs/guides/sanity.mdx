---
title: Sanity
description: Integrate Pocketlytics Analytics with your Sanity-powered website
---

import { Callout } from 'fumadocs-ui/components/callout';

Sanity is a headless CMS that provides content management for your applications. Since Sanity is headless, you'll add Pocketlytics Analytics to your frontend application rather than to Sanity itself.
...
## How to Add Pocketlytics with Sanity

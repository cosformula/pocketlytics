...
description: How to install and configure the Pocketlytics tracking script
---

import { Callout } from 'fumadocs-ui/components/callout';

To start tracking user activity on your website, add the Pocketlytics tracking script to your site's HTML.
...
```
If you are self-hosting Pocketlytics `app.pocketlytics.local` will be domain of your Pocketlytics instance.
...
Most tracking options are configured through your site settings in the Pocketlytics dashboard. The script automatically fetches these settings when it loads:

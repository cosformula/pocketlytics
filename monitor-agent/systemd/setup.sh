...
# Setup script for Pocketlytics Monitor Agent with systemd
...
# Configuration
INSTALL_DIR="/opt/pocketlytics-monitor-agent"
SERVICE_USER="pocketlytics"
SERVICE_NAME="pocketlytics-monitor-agent"
NODE_VERSION="20"
...
# Pocketlytics Monitor Agent Configuration
NODE_ENV=production
PORT=3000
HOST=0.0.0.0
...
# Main Server
MAIN_SERVER_URL=https://your-pocketlytics-server.com
...
cp pocketlytics-monitor-agent.service /etc/systemd/system/
...
cat > /etc/logrotate.d/pocketlytics-monitor-agent << EOF
...
if command -v ufw &> /dev/null; then
    ...
    ufw allow 3000/tcp comment "Pocketlytics Monitor Agent"
fi

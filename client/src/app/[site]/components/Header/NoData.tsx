        ...
        <Alert className="mt-4 p-4 bg-amber-50 border-amber-400/80 dark:bg-neutral-900 dark:border-amber-600/80">
          <div className="flex flex-col gap-3">
            ...
            <span className="text-xs text-muted-foreground">
              See our{" "}
              <a href="https://pocketlytics.local/docs/script" className="text-blue-500 hover:underline">
                docs
              </a>{" "}
              for more information, or{" "}
              <a href="https://pocketlytics.local/docs/script-troubleshooting" className="text-blue-500 hover:underline">
                troubleshoot
              </a>{" "}
            ...
            <div className="">
              ...
              <div className="flex flex-wrap gap-2">
                <Card
                  ...
                  description=""
                  href="https://pocketlytics.local/docs/guides/google-tag-manager"
                />
                <Card
                  icon={<SiReact className="w-5 h-5" />}
                  title="React"
                  description=""
                  href="https://pocketlytics.local/docs/guides/react/vite-cra"
                />
                <Card
                  icon={<SiNextdotjs className="w-5 h-5" />}
                  title="Next.js"
                  description=""
                  href="https://pocketlytics.local/docs/guides/react/next-js"
                />
                <Card
                  icon={<SiAngular className="w-5 h-5" />}
                  title="Angular"
                  description=""
                  href="https://pocketlytics.local/docs/guides/angular"
                />
                <Card
                  icon={<SiVuedotjs className="w-5 h-5" />}
                  title="Vue"
                  description=""
                  href="https://pocketlytics.local/docs/guides/vue/vite"
                />
                <Card
                  icon={<SiNuxt className="w-5 h-5" />}
                  title="Nuxt"
                  description=""
                  href="https://pocketlytics.local/docs/guides/vue/nuxt"
                />
                <Card
                  icon={<SiSvelte className="w-5 h-5" />}
                  title="Svelte"
                  description=""
                  href="https://pocketlytics.local/docs/guides/svelte/vite"
                />
                <Card
                  icon={<SiSvelte className="w-5 h-5" />}
                  title="SvelteKit"
                  description=""
                  href="https://pocketlytics.local/docs/guides/svelte/sveltekit"
                />
                <Card
                  icon={<img src="/platforms/thrivecart.svg" alt="ThriveCart" className="w-5 h-5 grayscale" />}
                  title="ThriveCart"
                  description=""
                  href="https://pocketlytics.local/docs/guides/thrivecart"
                />
                <Card
                  icon={<SiAstro className="w-5 h-5" />}
                  title="Astro"
                  description=""
                  href="https://pocketlytics.local/docs/guides/astro"
                />
                <Card
                  icon={<SiBigcommerce className="w-5 h-5" />}
                  title="BigCommerce"
                  description=""
                  href="https://pocketlytics.local/docs/guides/bigcommerce"
                />
                <Card
                  icon={<SiCarrd className="w-5 h-5" />}
                  title="Carrd"
                  description=""
                  href="https://pocketlytics.local/docs/guides/carrd"
                />
                <Card
                  icon={<SiContentful className="w-5 h-5" />}
                  title="Contentful"
                  description=""
                  href="https://pocketlytics.local/docs/guides/contentful"
                />
                <Card
                  icon={<SiGatsby className="w-5 h-5" />}
                  title="Gatsby"
                  description=""
                  href="https://pocketlytics.local/docs/guides/react/gatsby"
                />
                <Card
                  icon={<SiGhost className="w-5 h-5" />}
                  title="Ghost"
                  description=""
                  href="https://pocketlytics.local/docs/guides/ghost"
                />
                <Card
                  icon={<SiGitbook className="w-5 h-5" />}
                  title="GitBook"
                  description=""
                  href="https://pocketlytics.local/docs/guides/gitbook"
                />
                <Card
                  icon={<SiRemix className="w-5 h-5" />}
                  title="Remix"
                  description=""
                  href="https://pocketlytics.local/docs/guides/react/remix"
                />
                <Card
                  icon={<SiDocusaurus className="w-5 h-5" />}
                  title="Docusaurus"
                  description=""
                  href="https://pocketlytics.local/docs/guides/docusaurus"
                />
                <Card
                  icon={<SiDrupal className="w-5 h-5" />}
                  title="Drupal"
                  description=""
                  href="https://pocketlytics.local/docs/guides/drupal"
                />
                <Card
                  icon={<SiFramer className="w-5 h-5" />}
                  title="Framer"
                  description=""
                  href="https://pocketlytics.local/docs/guides/framer"
                />
                ...
                <Card
                  ...
                  title="Hugo"
                  description=""
                  href="https://pocketlytics.local/docs/guides/hugo"
                />
                <Card
                  icon={<SiJekyll className="w-5 h-5" />}
                  title="Jekyll"
                  description=""
                  href="https://pocketlytics.local/docs/guides/jekyll"
                />
                <Card
                  icon={<SiJoomla className="w-5 h-5" />}
                  title="Joomla"
                  description=""
                  href="https://pocketlytics.local/docs/guides/joomla"
                />
                <Card
                  icon={<SiLaravel className="w-5 h-5" />}
                  title="Laravel"
                  description=""
                  href="https://pocketlytics.local/docs/guides/laravel"
                />
                <Card
                  icon={<SiMintlify className="w-5 h-5" />}
                  title="Mintlify"
                  description=""
                  href="https://pocketlytics.local/docs/guides/mintlify"
                />
                <Card
                  icon={<SiPrestashop className="w-5 h-5" />}
                  title="PrestaShop"
                  description=""
                  href="https://pocketlytics.local/docs/guides/prestashop"
                />
                <Card
                  icon={<SiSanity className="w-5 h-5" />}
                  title="Sanity"
                  description=""
                  href="https://pocketlytics.local/docs/guides/sanity"
                />
                <Card
                  icon={<SiShopify className="w-5 h-5" />}
                  title="Shopify"
                  description=""
                  href="https://pocketlytics.local/docs/guides/shopify"
                />
                <Card
                  icon={<SiSquarespace className="w-5 h-5" />}
                  title="Squarespace"
                  description=""
                  href="https://pocketlytics.local/docs/guides/squarespace"
                />
                <Card
                  icon={<SiStrapi className="w-5 h-5" />}
                  title="Strapi"
                  description=""
                  href="https://pocketlytics.local/docs/guides/strapi"
                />
                <Card
                  icon={<SiVitepress className="w-5 h-5" />}
                  title="VitePress"
                  description=""
                  href="https://pocketlytics.local/docs/guides/vitepress"
                />
                <Card
                  icon={<SiWordpress className="w-5 h-5" />}
                  title="WordPress"
                  description=""
                  href="https://pocketlytics.local/docs/guides/wordpress"
                />
                <Card
                  icon={<SiWebflow className="w-5 h-5" />}
                  title="Webflow"
                  description=""
                  href="https://pocketlytics.local/docs/guides/webflow"
                />
                <Card
                  icon={<SiWix className="w-5 h-5" />}
                  title="Wix"
                  description=""
                  href="https://pocketlytics.local/docs/guides/wix"
                />
                <Card
                  icon={<SiWoocommerce className="w-5 h-5" />}
                  title="WooCommerce"
                  description=""
                  href="https://pocketlytics.local/docs/guides/woocommerce"
                />
              </div>
            </div>
          </div>

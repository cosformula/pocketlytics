...
import { PocketlyticsTextLogo } from "../../../components/PocketlyticsLogo";
...
export default function AppSumoSignupPage() {
  useSetPageTitle("Pocketlytics · AppSumo Signup");
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return (
          <div>
            <h2 className="text-2xl font-semibold mb-2">Welcome to Pocketlytics!</h2>
    ...
    <div className="flex justify-center items-center h-dvh w-full p-4 bg-background">
      <div className="flex flex-col items-center relative">
        ...
        <div className="relative z-10 mb-6 text-center">
          <a href="https://pocketlytics.local" target="_blank" className="inline-block mb-2">

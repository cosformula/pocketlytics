...
TEST_USER_EMAIL="${TEST_USER_EMAIL:-test@pocketlytics-lite.local}"
TEST_USER_PASSWORD="${TEST_USER_PASSWORD:-PocketlyticsLite!12345}"
TEST_USER_NAME="${TEST_USER_NAME:-pocketlytics-lite-test}"
TEST_ORG_NAME="${TEST_ORG_NAME:-Pocketlytics Lite}"
TEST_ORG_SLUG="${TEST_ORG_SLUG:-pocketlytics-lite}"
TEST_SITE_NAME="${TEST_SITE_NAME:-Pocketlytics Lite Dev Site}"
